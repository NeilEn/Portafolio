    ...
    <footer className="bg-secondary-900 dark:bg-secondary-950 text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <p className="text-secondary-300 mb-4">
              Project & Operations Manager especializado en metodologías Agile y optimización de flujos de trabajo digitales.
            </p>
        ...
        <div className="border-t border-secondary-800 mt-8 pt-8 text-center text-secondary-400">
          <p>&copy; {new Date().getFullYear()} Neil Endicott. Todos los derechos reservados.</p>
        </div>
      </div>
    </footer>
  )
